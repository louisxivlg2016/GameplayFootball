...
*/
  ...
  // NB: "/templates" (leading slash) makes std::filesystem's operator/ treat it
  // as absolute and discard `directory` (-> "/templates", which doesn't exist);
  // Boost appended it. "templates" appends correctly for both.
